...
public class DMUtils {
     ...
     * does get the path...  of Netbeans.. lol...
     * ... Todo: adjust this to work with concepts from the LoadImagefromJar...
     * ... and we can make it work for custom defined themes dynamically in conjunction
     * with the functionality available from Nilo's NimROD base. END NOTE...
     * 
     * @param relativePath
     * @return
    ...
    /**
     * <p>This method loads a picture from a relative path string. The relative path's
     * root directory is understood to be inside of a jar... and in relation to the
     * package of the referring Object instance.
     * </p>
     * <p>For example: if the object is an instance of 
     * org.jme3.netbeans.plaf.darkmonkey.DarkMonkeyIconFactory.class, and the string
     * is "icons/MyCloseIcon.png", it will attempt to load
     ...
     * 
     * @param refObj - Reference Object(Object) - meant for a standard 'this' call, though
     *  any Instantiated class can be used. This is part of a workaround for Netbean's
     *  multiple class loader system.
     * @param fileName - File Name(String) - the path to an image relative to the
     *  Reference Object's location in a jar file.
     * @return BufferedImage - Freshly converted from the image file found at the 
     *  location.
     */
     ...
     * The behavior treats the Color[] as Ordered Passes A, R, G, B for .length 4 or more.
     * It treats it as Ordered Passes R, G, B only for .length 3 or less.
     * 
     * @param colorSet Color[] that processes [1..4] up to four palette colors. 
     * 3 or less uses R,G,B passes only. 4 uses A,R,G,B and ignores anything more.
     * @param clearToColorRequested - A color to Blend with the First Translucent Pass - Optional
     * @param argbMappedBufferedImage - The image containing Channels as Alpha for the Palette
